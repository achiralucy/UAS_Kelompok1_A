...
// Data resi untuk ditampilkan ke popup (diisi setelah booking berhasil)
$resiData = null;
...
function submitBooking() {
    document.getElementById('durasi').value         = document.getElementById('durasi_select').value;
