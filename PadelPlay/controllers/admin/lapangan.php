...
function uploadFoto($fileInput, $conn) {
    ...
    $dirImages = __DIR__ . '/../../assets/images/';
    if (!is_dir($dirImages)) {
        mkdir($dirImages, 0755, true);
    }

    $namaFile = 'lapangan_' . time() . '_' . bin2hex(random_bytes(4)) . '.' . $ekstensi;
    $tujuan   = $dirImages . $namaFile;

    if (!move_uploaded_file($file['tmp_name'], $tujuan)) {
        return ['ok' => false, 'pesan' => 'Gagal menyimpan gambar ke server. Pastikan folder assets/images/ bisa ditulis.'];
    }
...
<div class="admin-wrapper">
    ...
    <div class="sidebar-overlay" onclick="document.body.classList.remove('admin-menu-open')"></div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area" onclick="document.getElementById('foto-tambah').click()">
                        <input type="file" name="foto" id="foto-tambah" accept=".jpg,.jpeg,.png" onchange="previewFoto(this, 'preview-img-tambah', 'preview-tambah')">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="upload-area" onclick="document.getElementById('foto-edit').click()">
                        <input type="file" name="foto" id="foto-edit" accept=".jpg,.jpeg,.png" onchange="previewFoto(this, 'preview-img-edit', 'preview-edit')">
...
function previewFoto(input, targetImgId, wrapId) {
