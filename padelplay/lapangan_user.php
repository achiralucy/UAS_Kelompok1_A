...
<nav class="navbar">
    ...
    <ul class="navbar-nav">
        ...
        <li><a href="lapangan_user.php" class="active">Lapangan</a></li>
        <?php if ($sudahLogin): ?>
    ...
    <div class="navbar-actions">
        ...
        <?php else: ?>
            ...
            <a href="register_user.php" class="btn-daftar">Daftar</a>
        <?php endif; ?>
    </div>
</nav>
        ...
        <?php if ($res && $res->num_rows > 0): ?>
            ...
            <div class="card-lapangan">
                <div class="card-lapangan-foto">
                    <img 
                        src="<?= !empty($l['foto']) ? htmlspecialchars($l['foto']) : 'Padel.jpeg' ?>" 
                ...
                <div class="card-lapangan-body">
                    ...
                    <div class="card-lapangan-footer">
                        ...
                        <?php if ($sudahLogin): ?>
                            <a href="booking_user.php?lapangan=<?= $l['id'] ?>" class="btn-booking">Booking</a>
                        <?php else: ?>
